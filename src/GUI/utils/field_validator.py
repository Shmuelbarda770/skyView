...
class FieldValidator:
    ...
    def validate_all_field(
        ...
        if (
            not FieldValidator._validate_route_id(route_id_value)
            or not FieldValidator._validate_platform_name(platform_name_value)
            or not FieldValidator._validate_platform_id(platform_id_value)
            or not FieldValidator._validate_platform_flight_index(platform_flight_index_value)
            or not FieldValidator._validate_date(date_value)
        ):
