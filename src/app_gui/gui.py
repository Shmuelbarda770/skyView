...
from src.sardine_lisener.socket_thread_manager import SocketThreadManager
...
class GUI:
    ...
    def create_elements(self):
        ...
        self.explanation_text_received_json_counter: Text = ft.Text(value="Count of received JSON data from the drone: ",color="white")
        self.sent_json_counter: Text = ft.Text(value="0",color="white")
        self.explanation_text_sent_json_counter: Text = ft.Text(value="Number of JSON sent to the cloud: ",color="white")
    ...
    def update_traffic_light_status(self,status_indicator: str):
